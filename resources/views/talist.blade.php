...
<head>
    ...
    <link href="{{ asset('talist.css') }}" rel="stylesheet" type="text/css">
...
<div class="content">
        ...
        <tbody>
            @foreach($students as $student)
                <tr>
                    ...
                    <td><form id="deletestd" action="{{ route('deleteta') }}" method="post">

                        @csrf
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16" class="deleteicon" class="deleteicon" stdid="{{ $student->id }}" stdname="{{ $student->fname }}">
    ...
    <div class="filtercontainer">
        <button id="addta" class="addta" onclick="addta()">เพิ่ม TA</button>

    </div>

<script>
       function addta() {
        window.location.href = '/addta';
    }
